...
export class DrinksService {
  ...
  saveDrink(drink: Drink) {
    if (drink.id >= 0) { // patch
      this.http.patch(this.url + '/drinks-update/' + drink.id, drink, this.getHeaders())
      .subscribe( (res: any) => {
        if (res.success) {
          this.drinksToItems(res.drinks);
        }
      ...
      this.http.post(this.url + '/drinks-post', drink, this.getHeaders())
      .subscribe( (res: any) => {
        if (res.success) {
          this.drinksToItems(res.drinks);
        }
  ...
  deleteDrink(drink: Drink) {
    ...
    this.http.delete(this.url + '/drinks-delete/' + drink.id, this.getHeaders())
    .subscribe( (res: any) => {
